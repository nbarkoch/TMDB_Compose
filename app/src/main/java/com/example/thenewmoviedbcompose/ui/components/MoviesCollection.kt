...
fun MoviesCollectionPreview() {
    val movies = listOf(moviePreviewMock, moviePreviewMock, moviePreviewMock, moviePreviewMock)
    MoviesCollection(movies = movies, isLoading = true, onDetailsClick = {}, onEndReached = {})
}